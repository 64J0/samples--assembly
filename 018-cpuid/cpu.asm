...
section .data							
        ...
        fmt_ssse3	db "This cpu supports SSE 3",10,0
...
cpu_sse:
	...
	mov rbp,rsp
        ...
        ;test for SSE
        test edx,2000000h	; hexadecimal value 2000000h, test bit 25 (SSE)
...
sse2:
        test edx,4000000h   	; hexadecimal value 4000000h, test bit 26 (SSE 2)
