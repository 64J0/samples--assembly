section .data
        ...
        ; syscall symbols
        ; check /usr/include/asm/unistd.h
        NR_read   equ 0
        NR_write  equ 1
        NR_open   equ 2
        NR_close  equ 3
        ...
        text1     dq "1. Hello...to everyone!",NL,0
        len1      dq $-text1-1  ; remove 0
        text2     dq "2. Here I am!",NL,0
        len2      dq $-text2-1  ; remove 0
        text3     dq "3. Alive and kicking.",NL,0
        len3      dq $-text3-1  ; remove 0
        text4     dq "4. Adios...",NL,0
        len4      dq $-text4-1  ; remove 0
